...
*/
{
    ...
    class Item {
        constructor(el) {
            ...
            this.DOM = {el: el};
            // the inner image
            this.DOM.image = this.DOM.el.querySelector('.img-responsive');
            this.renderedStyles = {
    ...
    class SmoothScroll {
        constructor() {
            // the <main> element
            this.DOM = {main: document.querySelector('.section__intro')};
            // the scrollable element
            // we translate this element when scrolling (y-axis)
            this.DOM.scrollable = this.DOM.main.querySelector('div[data-scroll]');
            // the items on the page
            this.items = [];
            [...this.DOM.main.querySelectorAll('.image__front')].forEach(item => this.items.push(new Item(item)));
